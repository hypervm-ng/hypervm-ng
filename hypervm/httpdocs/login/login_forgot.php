      ...
      <div class="login">
            <form name=sendmail action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                  ...
                  <div class="inputfield">
                        <table>
                              <tr>
                                    <td><img src="/img/loginskin/mail_icon.png" height="20" /></td>
                                    <td><input name="frm_email" type="text" class="inputbox" size=30 placeholder="Email Address" /></td>
                              </tr>
                        </table>
                  </div><br>
            ...
            <div class="forgotpassword">
                  <a class="forgotpwd" href="javascript:history.go(-1);">
                        <font color="black">Back to Login
                  </a>
            </div>
            <script>
