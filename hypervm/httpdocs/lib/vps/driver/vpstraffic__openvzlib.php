...
static function iptables_create()
{
	...
	foreach($list as $l) {
		...
		if(self::isIPV6($l)){
			exec("ip6tables -I FORWARD 1 -s $l -j ACCEPT");
			exec("ip6tables -I FORWARD 1 -d $l -j ACCEPT");
		}
		else{
			exec("iptables -I FORWARD 1 -s $l -j ACCEPT");
			exec("iptables -I FORWARD 1 -d $l -j ACCEPT");
		}
	}
}
