            ...
            <tbody>
                <tr>
                    ...
                    function CreateMenuItemRightSide($id)
                    {
                        ...
                        <table border='0' cellspacing='0' cellpadding='0' style='font-size:8pt;color:#004466;height:34px;width:73px;background:url(<?php echo $skindir; ?>right_btn.gif);' OnMouseOver="style.cursor='pointer'; top.mainframe.changeContent('help','<?php echo $name; ?>');" <?php echo $onclickstring ?> OnMouseOut="changeContent('help','helparea')">
                            <tr>
                                <td valign='bottom' width='17' height='34' align='left' style='padding-bottom:2px;padding-left:4px'>
                                    <img height='12' width='12' src='/img/image/<?php echo $login->getSpecialObject('sp_specialplay')->icon_name ?>/button/<?php echo $icon; ?>'>
                                </td>
                                <td valign='bottom' width='53' style='padding-left:3px;padding-bottom:3px;' align='left'>
                                    <p <?php echo $fontStyle; ?>><?php echo $name; ?></p>
                                </td>
                            </tr>
                        </table>
                    ...
                    ?>
                        <table width='85' cellspacing='0' cellpadding='0' border='0' style='font-size:8pt;color:#004466;height:34px;margin:0;background:url(<?php echo $login->getSkinDir();
                                                                                                                                                            echo $bgimg; ?>)' OnMouseOver="style.cursor='pointer' ;  top.mainframe.changeContent('help','<?php echo $name; ?>');" onClick="top.mainframe.location='<?php echo $url; ?>';" OnMouseOut="top.mainframe.changeContent('help','helparea')">
                            <tr>
