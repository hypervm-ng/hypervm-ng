...
*/
		...
		function printSelectObjectTable($name_list, $parent, $class, $blist = array(), $display = null)
		{
			...
			?>
					...
					<
					script >
					var ckcount<?php echo $unique_name; ?>;
		</script>
		<?php
			$tsortby = $sortby;
			if (!$sortby) {
						...
						<tr>
							...
							<td colspan=<?php echo $nlcount; ?>>
								<table cellpadding=0 cellspacing=0 border=0 width=100%>
											...
											?>
												<table cellpadding=0 cellspacing=0 border=0 height=27>
													...
													<tr>
														...
														<td nowrap valign=middle background="<?php echo $imgheadbg; ?>"><b>
																<font color="#ffffff"><?php echo get_plural($classdesc[2]) ?> under <?php echo $parent->display("nname") ?>
															</b> <?php echo $this->print_machine($parent) ?> <b> (<?php echo $total_num ?>)</b></font>
														</td>
									...
									<tr>
										<td colspan=3>
											<table cellpadding=0 cellspacing=0 border=0 width=100% height=35 background="<?php echo $imgbtnbg; ?>">
												<tr>
													...
													<td width=15% align=right><b>
															<font color="#ffffff"><?php $this->print_search($parent, $class); ?></font>
														</b></td>
												</tr>
											</table>
										</td>
						...
						<tr>
							...
							<td align=right>
								<table cellpadding=0 cellspacing=0 border=0 width=100%>
									<tr>
										<td><img src="<?php echo $imgheadleft; ?>"></td>
										<td nowrap width=100% background="<?php echo $imgheadbg; ?>"><b>
												<font color="#ffffff"> Confirm <?php echo $descr[1] ?>:
											</b><?php echo get_plural($classdesc[2]) ?> from <?php echo $parent->display("nname"); ?></font>
										</td>
										<td><img src="<?php echo $imgheadright; ?>"></td>
									</tr>
								</table>
	...
	<tr>
		...
		<td width=10 background=<?php echo $imgtablerowhead ?>>
			<form name="formselectall<?php echo $unique_name; ?>" value=hello> <input type=checkbox name="selectall<?php echo $unique_name; ?>" value=on <?php if ($sellist) echo "checked disabled";  ?> onclick="javascript:calljselectall<?php echo $unique_name; ?> ()"></form>
		</td>
		<?php
	...
	<tr id=tr<?php echo $unique_name . $rowcount; ?> class=tablerow<?php echo $count; ?> onmouseover=" swapImage('imgpoint<?php echo $rowcount; ?>','','<?php echo $imgpointer; ?>',1);" onmouseout="swapImgRestore();">
		...
		?>
			<table width=95%>
				<tr align=center>
					<td width=100%> <b> No <?php echo get_plural($classdesc[2]) ?> under <?php echo $parent->nname ?> </b> </td>
				</tr>
			</table>
	<?php
				}
	...
	?>
	<script>
		ckcount<?php echo $unique_name; ?> = <?php echo $rowcount . ";  "; ?>
