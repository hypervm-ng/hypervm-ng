...
echo ""
echo "HyperVM Upgrade to Legacy HyperVM powered by HyperVM-NG team"
echo "============================================================"
echo "Current version: $(sh /script/version)"
echo ""
pause "Hit [ENTER] to continue or ctrl-c to exit"
echo ""
wget --no-check-certificate https://raw.githubusercontent.com/hypervm-ng/hypervm-ng/legacy/hypervm/bin/raw_update.phps -O /usr/local/lxlabs/hypervm/bin/raw_update.phps
